const Southwest = ({ sendStoryToState }) => {

    return (
        <>
            <div id='southwest' className='content-main solid'>
                <h1 className='text-center'>Southwest</h1>
                <div className='mt-4'>
                    <div className="container">
                        <div className="row">
                            <div className="col-4">
                                ...
                                <button type="button" className="btn btn-outline-primary" onClick={() => sendStoryToState('southwest01')}>Primary</button>
                            </div>
                            <div className="col-4">
                                ...
                                <button type="button" className="btn btn-outline-primary" onClick={() => sendStoryToState('southwest02')}>Primary</button>
                            </div>
                            <div className="col-4">
                                ...
                                <button type="button" className="btn btn-outline-primary" onClick={() => sendStoryToState('southwest03')}>Primary</button>
                            </div>
                        </div>
                    </div>
                </div>
